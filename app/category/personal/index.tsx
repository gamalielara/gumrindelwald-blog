...
import { BlogsPage, Category } from "../../../app/utils/vars";
import { queryBlogs } from "../../../app/utils/helpers";
...
const CategoryPage: NextPage<BlogsPage> = ({ blogs }) => {
  return (
    <>
      ...
      <PageContainer pageName="personal-thoughts-blogs">
...
export async function getStaticProps() {
  const personalBlogs = await queryBlogs({
    field: "category",
